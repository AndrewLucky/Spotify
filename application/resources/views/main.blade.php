...
<html>
    <head>
        ...
        <link rel="stylesheet" id="main-stylesheet"
              href="{{ asset('assets/css/custom-stylesheets', $settings->get('enable_https')).'/'.(($settings->get('selected_sheet') && ! IS_DEMO) ? $settings->get('selected_sheet').'/styles.min.css?v31' : 'original/styles.min.css?v31') }}">
    ...
    <div id="splash" ng-cloak>
        ...
        <script src="{{ asset('assets/js/core.min.js?v31', $settings->get('enable_https')) }}"></script>
